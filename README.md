...
My discord bot for my discord servers. His name is Богдан (Bogdan).
This bot behaves himself as a human with customizable mood/style and name (AI token required).
Other features:
